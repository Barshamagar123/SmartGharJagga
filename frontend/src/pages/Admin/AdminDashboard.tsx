...
import type {Property } from '../../services/api/admin';
...
// ✅ Use the Property type from admin.ts directly
// No need for separate RecentProperty interface
...
const AdminDashboard: React.FC = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // ✅ Set recent properties - use as-is from API
  ...
  // ✅ Updated property columns to match Property type
  const propertyColumns = [
    ...
    },
    {
      key: 'status',
      label: 'Status',
      render: (row: Property) => <StatusBadge status={row.status} />
    },
    {
      key: 'user',
      label: 'Listed By',
