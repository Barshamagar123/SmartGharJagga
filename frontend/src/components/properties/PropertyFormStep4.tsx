...
const PropertyFormStep4: React.FC<Step4Props> = ({ formData }) => {
  // ✅ formData.price is stored as a string while the form is being filled
  // out, so guard against it being '', undefined, or NaN before formatting.
        ...
        <div>
          ...
          <div className="flex gap-4 text-sm">
            ...
            <span>
              ...
              <span className="font-medium">{formData.videos?.length || 0}</span>
            </span>
          </div>
        </div>
      </div>
