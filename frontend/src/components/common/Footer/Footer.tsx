        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link 
                  to="/properties" 
                  className="text-[var(--color-text-secondary)] hover:text-[#2D5A27] transition-colors text-sm"
                >
                  Properties
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-[var(--color-primary-border)] hover:bg-[#2D5A27] transition-all duration-200 flex items-center justify-center text-[var(--color-text-secondary)] hover:text-white"
                aria-label="Facebook"
              >
        ...
        <div className="border-t border-[var(--color-primary-border)] mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-[var(--color-text-tertiary)]">
              © {currentYear} SmartGharJagga. All rights reserved.
            </p>
            <p className="text-sm text-[var(--color-text-tertiary)]">
              Nepal's Smart Real Estate Platform
            </p>
          </div>
        </div>
      </div>
